...
f000START	SEI                     ; Disable interrupts
f001		CLD                     ; Clear decimal bit
f002		LDX  #StkTop
f004		TXS                     ; Init Stack
f005		LDX  #$5D
f007		JSR  ClearMem           ; zero out RAM except address $A2
f00a		LDA  #$10		;
f00c		STA  SWCHB+1            ; Port B data direction register and
f00f		STA  GameOn             ; GameOn (tho not quite a valid value)...
f011		JSR  ClrGam		; clear game RAM $82-$A2
			;
...
f1a3	ClrGam  LDX  #$DF               ; Clear data from current game ($82-$A2)
f1a5	ClrGRST JSR  ClearMem
f1a8		LDA  #$FF
f1aa		STA  SelDbnce           ; Set flag: Sel has been down.
f1ac		LDY  BINvar
f1ae		LDA  VARMAP,Y           ; Get feature bits for this variation.
f1b1		STA  GAMVAR
f1b3		EOR  #$FF               ; #$FF signifies end of variations
...
f5bf	ClrLoop	INX  
f5c0		STA  $A2,X
f5c2		BNE  ClrLoop  ;Continue until X rolls over.
f5c4		RTS  
